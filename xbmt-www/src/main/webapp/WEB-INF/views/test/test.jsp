...
<body>
	...
	<ul>
		...
		<li><a href="${pageContext.request.contextPath}/test/test/gotoOMUI">测试Operamasks UI</a></li>
		<li><a href="${pageContext.request.contextPath}/test/test/gotoEasyui">测试Easy UI</a></li>
		<li><a href="${pageContext.request.contextPath}/test/test/gotoEasyui?pageName=easyui2">测试Easy UI2</a></li>
		<li><a href="${pageContext.request.contextPath}/test/test/gotoEasyui?pageName=index">测试Easy UI 布局</a></li>
		<li><a href="${pageContext.request.contextPath}/test/test/gotoEasyui?pageName=editGrid">测试Edit DataGrid UI 布局</a></li>
