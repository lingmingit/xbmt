...
<head>
	<title>系统模块管理</title>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/admin/sys/functionAction.js"> </script>
</head>
<body>
	<!-- 列表grid -->
	    <table id="listDataGrid" class="easyui-datagrid" title="系统功能" 
            data-options="fit:true,idField:'id',rownumbers:true,singleSelect:false,pagination:true,url:'${pageContext.request.contextPath}${AdminRequestURI}/sys/functionAction/list',method:'post',toolbar:'#tb'">
        <thead>
            <tr>
                ...
                <th data-options="field:'buttonId',width:100,align:'left'">按钮Id</th>
                <th data-options="field:'actionName',width:100,align:'left'">事件名称</th>
