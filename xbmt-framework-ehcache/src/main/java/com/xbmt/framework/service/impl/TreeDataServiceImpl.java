 ...
 * @version 1.0<br>
 */
public abstract class TreeDataServiceImpl<E extends AbstractTreeData, ID extends java.io.Serializable> extends DataBaseServiceImpl<E, ID> implements ITreeDataService<E, ID> {
