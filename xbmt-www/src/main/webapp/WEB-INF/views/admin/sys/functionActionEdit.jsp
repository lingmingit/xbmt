...
<body style="margin-top:0px;margin-left: 0px;">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/admin/sys/functionActionEdit.js"> </script>
	<div class="right clear" >
    	<div id="nav_cont">
                <!--  <h1 id="tag_1" class="cont_tag_show"></h1> -->
                 <form id="editform" method="post" action="${pageContext.request.contextPath}${AdminRequestURI}/sys/functionAction/save">
                   ...
                   <table  border="0" class="grid_layout"  cellspacing="0" >
	                  <tr class="style1">
	                  ...
	                  <tr>
	                    <td align="right"><span class="color_red">*</span>按钮id：</td>
	                    <td colspan="3">
	                    	   <input type="text" id="buttonId" name="buttonId" class="easyui-textbox" data-options="required:true" style="width: 60%;" value="${data.buttonId}"/>
	                    </td>
	                     <td align="right"><span class="color_red">*</span>事件名称：</td>
	                    <td colspan="3"><input type="text" name="actionName" id="actionName" class="easyui-textbox" data-options="" style="width: 60%;" value="${data.actionName}" />
	                    </td>
	                  </tr>
                    <tr>
