 ...
 * @version 1.0<br>
 */
public abstract class DataBaseEhcacheServiceImpl<E extends AbstractDataBase, ID extends java.io.Serializable>  
	extends CoreBaseEhcacheServiceImpl<E, ID> implements IDataBaseService<E, ID> {
	 ...
	 */
	public DataBaseEhcacheServiceImpl(IDataBaseDao<E, ID> dataBaseDao) {
		super(dataBaseDao);
