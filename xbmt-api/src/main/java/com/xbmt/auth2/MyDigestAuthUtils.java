 ...
 * 由于 Spring  security 的  这个DigestAuthUtils类 只能在同包下调用，其它包不能调用，现在重写该类
 * @author admin
 *
 */
public class MyDigestAuthUtils {
	  ...
	  private static final String[] EMPTY_STRING_ARRAY = new String[0];
	    ...
	    public static String generateDigest(boolean passwordAlreadyEncoded, String username, String realm, String password,
	        ...
	        if (passwordAlreadyEncoded) {
	            ...
	            a1Md5 = MyDigestAuthUtils.encodePasswordInA1Format(username, realm, password);
	        }
