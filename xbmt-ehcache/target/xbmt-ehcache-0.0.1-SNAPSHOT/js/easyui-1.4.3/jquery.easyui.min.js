...
if(col){
  var _794=_791[_793];//update by LingMin @2015-11-03 
 if(!$.isEmptyObject(_791)){_794=eval("_791['"+_793.replace(/\./g,"']['")+"']");}
...
if(col){
var fieldVal = row[_8f1];//update by LingMin @2015-11-03
if(!$.isEmptyObject(row)){fieldVal=eval("row['"+_8f1.replace(/\./g,"']['")+"']");}
var css=col.styler?(col.styler(fieldVal,row)||""):"";
var _8f2="";
var _8f3="";
if(typeof css=="string"){
_8f3=css;
...
//val=row[_8f1]; //update by LingMin @2015-11-03
val=fieldVal;
}
