...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/admin/sys/modules.js"> </script>
</head>
<body>
	<!-- 列表grid -->
	    <table id="listDataGrid" class="easyui-datagrid" title="系统模块" 
            data-options="fit:true,idField:'id',rownumbers:true,singleSelect:false,pagination:true,url:'${pageContext.request.contextPath}${AdminRequestURI}/sys/modules/list',method:'post',toolbar:'#tb'">
        <thead>
            <tr>
                ...
                <th data-options="field:'moduleURL',width:150,align:'left'">URL</th>
                <th data-options="field:'description',width:240,align:'left'">备注</th>
                 <th data-options="field:'creator.id',width:80,align:'center'">创建人1</th>
