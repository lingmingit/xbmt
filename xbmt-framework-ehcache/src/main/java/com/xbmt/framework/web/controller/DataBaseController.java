...
/** 
 * 基础资料后台管理 业务处理  Controller 抽象基类<p>
 * @author LingMin 
 * @date 2015-10-15<br>
 * @version 1.0<br>
 */
public abstract class DataBaseController<E extends AbstractDataBase, ID extends java.io.Serializable> extends BaseListController<E , ID>{
